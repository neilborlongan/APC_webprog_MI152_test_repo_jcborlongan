...
<table >
  ...
  <tr>
    ...
    <ul><td class="t">
	<li>Playing</li>
	<img src= url(http://localhost/exercise6/codeigniter/uploads/discover.jpg); style="width:400px;height:300px;" height: 200px; weight : 200px;> <br>
	<li>Guitar</li>
	<img src= url(http://localhost/exercise6/codeigniter/uploads/cook.jpg); style="width:400px;height:300px;" height: 200px; weight : 200px;> <br>
	<li>Singing</li>
	<img src=url(http://localhost/exercise6/codeigniter/uploads/learn.jpg) style="width:400px;height:300px;" height: 200px; weight : 200px;> <br>
	</td></ul>
